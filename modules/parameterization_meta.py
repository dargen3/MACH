...
def parameterization_meta(sdf_file, ref_charges, parameters, method, optimization_method, minimization_method, atomic_types_pattern, num_of_samples, num_of_candidates, parameterization_subset, cpu, RAM, walltime, random_seed):
    if not parameters:
