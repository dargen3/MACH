...
def parameterization_meta(sdf_file, ref_charges, parameters, method, optimization_method, minimization_method, atomic_types_pattern, num_of_molecules, num_of_samples, num_of_candidates, subset_heuristic, validation, cpu, RAM, walltime):
    if not parameters:
    ...
    command = "./mach.py --mode parameterization --method {} --optimization_method {} --minimization_method {} --parameters {} --sdf {} --ref_charges {} " \
              " --data_dir results_data --cpu {} --git_hash {} --atomic_types_pattern {} --subset_heuristic {} --num_of_samples {} --validation {} --num_of_candidates {}" \
              .format(method, optimization_method, minimization_method, basename(parameters), basename(sdf_file),
                      ...
                      atomic_types_pattern, subset_heuristic, num_of_samples, validation, num_of_candidates)
