...
def write_to_file(charges, results, set_of_molecules):
...
def calculate_charges(sdf, method, parameters, charges, rewriting_with_force):
    ...
    print(colored("ok\n", "green"))
    write_to_file(charges, method.results, set_of_molecules)
