...
def load_arguments():
    ...
    parser.add_argument("--parameterization_subset", help="Use for parameterization mode only. Minimal subset of molecules that contains n atoms of each atom type is used for parameterization. Other molecules are used for validation.", default=100, type=int)
    ...
    parser.add_argument("--atomic_types_pattern",
                        ...
                        choices=("plain", "hbo", "hbob"), default="hbo")
