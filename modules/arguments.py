...
def load_arguments():
    ...
    parser.add_argument("--method", help="Empirical method for calculation partial atomic charges.",
                        choices=("EEM", "SFKEEM", "QEq", "GM", "MGC", "SQE", "ACKS2", "DDACEM"))
    ...
    parser.add_argument("--subset_heuristic", help="Only for optimization method guided minimization. For first step of GM is used only n% of set of molecules.", default=False)
    ...
    if args.mode == "set_of_molecules_info":
        ...
        if args.ref_charges is None or args.method is None \
                or args.sdf is None or args.charges is None \
            ...
            parser.error("For parameterization must be choice --ref_charges, --method, --sdf, "
                         " --optimization_method, --data_dir and --charges.")
